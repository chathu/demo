...
.fitem label {
            ...
            <header class="head">
                ...
                <div class="main-bar">
                    <div class="container-fluid">
                        <div class="row-fluid">
                            <div class="span12">
                                <h3><i class="icon-check-empty"></i> Gap Analysis</h3>
            ...
            <div id="left">
                ...
                <ul id="menu" class="unstyled accordion collapse in">
                    ...
                    <li><a href="#"><i class="icon-file icon-large"></i> Risk Assestment </a></li>
                          <li class="accordion-group active"><a data-parent="#menu" data-toggle="collapse" class="accordion-toggle" data-target="#soa-nav" > <i class="icon-tasks icon-large"></i>Statement of Applicability <span
                                class="label label-inverse pull-right">2</span> </a>
        <ul class="collapse " id="soa-nav">
          <li><a href="#"><i class="icon-angle-right"></i> ISMS Mandatory</a></li>
          <li><a href="#"><i class="icon-angle-right"></i> Support Utilities</a></li>
        </ul>
      </li>
                    <li class="accordion-group ">
	...
	<div class="demo-info" style="margin-bottom:10px">
		...
		<div>Select the field and change the status.</div>
	</div>
	
	<table id="dg" title="Mandatory requirement for the ISMS" class="easyui-datagrid" style="width:auto;height:250px"
			url="get_users.php"
