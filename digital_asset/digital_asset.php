                ...
                <ul id="menu" class="unstyled accordion collapse in">
                    ...
                    <li class="accordion-group active">
                        ...
                        <ul class="collapse " id="component-nav">
                            ...
                            <li><a href="#"><i class="icon-angle-right"></i> Digital Asset</a></li>
...
<div class="demo-info" style="margin-bottom:10px">
      ...
      <div>Click the buttons on datagrid toolbar to add, modify, delete digital asset.</div>
    </div>
<table id="dg" title="Digital Asset" class="easyui-datagrid" style="width:auto;height:250px"
			url="get_users.php"
...
<div id="toolbar"> <a href="#" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="newUser()">New Asset</a> <a href="#" class="easyui-linkbutton" iconCls="icon-edit" plain="true" onclick="editUser()">Edit Asset</a> <a href="#" class="easyui-linkbutton" iconCls="icon-remove" plain="true" onclick="removeUser()">Remove Asset</a> </div>
